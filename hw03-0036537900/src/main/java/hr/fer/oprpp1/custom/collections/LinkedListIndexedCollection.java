 ...
 * */
    ...
    public void insert( T value,int position) {
        ...
        if (position == size) {
            ...
            if (position <= middle) {
                ...
                var newNode = new ListNode<T>(value, head.previous, head);
    ...
    @Override
        ...
        public void add (T value){
            ...
            var newNode = new ListNode<T>(value, last, null);
        ...
        public T[] toArray () {
            ...
            var array =(T[]) new Object[this.size];
            var head = first;
            int i = 0;
            while (head != null) {
                array[i++] = head.value;
    ...
    public ElementsGetter<T> createElementsGetter() {
        return new LinkedListElementsGetter<T>(this, this.modificationCount);
    }
    ...
    private static class LinkedListElementsGetter<T> implements ElementsGetter<T> {
        ...
        public LinkedListElementsGetter(LinkedListIndexedCollection<T> collection, int ModificationCount) {
